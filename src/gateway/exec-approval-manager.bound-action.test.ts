// Core-owned settlement and binding proof for SMS-origin approvals. This fixture
// launches no transport or command; SMS rendering/authorization stays in its plugin tests.
...
describe("disposable SMS approval contract", () => {
  it("releases one exact harmless action once and rejects changed or replayed actions", async () => {
